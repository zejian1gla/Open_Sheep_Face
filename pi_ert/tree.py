...
class TreeBuilder(RegressorBuilder):
    ...
    def build(self, pixel_vectors, targets, pixel_mean_coords):
        ...
        for i in range(self.n_nodes):
            split, begin, midpoint, end, best_sums, permute = self.find_best_split(pixel_vectors, targets,
                                                                                   self.n_test_split, permute,
                                                                                   pixel_mean_coords, node_buckets[i],
                                                                                   node_sums[i], node_cnts[i])
    ...
    def find_best_split(self, pixel_vectors, targets, n_test_split, permute, pixel_mean_coords, node_bucket, node_sum,
                        node_cnt):

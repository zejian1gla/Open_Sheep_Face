...
3. Click from menu: file -> settings, click "Python interpreter" under the Project: Open_Sheep_Face-master. Click add interpreter, you can create a virtual environment here, the option "inherit global site-packages" should be chosen. Click save.
